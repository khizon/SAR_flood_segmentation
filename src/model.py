...
class SegModule(LightningModule):
    def __init__(self, model, lr=1e-3, max_epochs=30, **kwargs):
        ...
        self.jaccard, self.precision, self.recall, self.f1 = BinaryJaccardIndex(), BinaryPrecision(), BinaryRecall(), BinaryF1Score()
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.test_step_outputs.append({
            'test_miou': self.jaccard(y_hat, y.int()),
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.validation_step_outputs.append({
            'val_miou': self.jaccard(y_hat, y.int()),
